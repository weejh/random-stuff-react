	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function whenUserTypes(e) {
	      ...
	      fetch('https://api.redmart.com/v1.5.6/catalog/search?q=' + query + '&pageSize=18&sort=1').then(function (response) {
	  ...
	  _createClass(SearchBox, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'searchbox' },
	        _react2['default'].createElement('input', { onChange: this.props.whenUserTypes, type: 'text', placeholder: 'Just Search Lah ...' })
	      );
	    }
	  }]);
